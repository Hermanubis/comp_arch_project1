...
/*
Team number: 22
Team members: Alex Li, Will Daughtridge
*/
...
int main(){
  ...
  /* Example for ques0 */
	...
	//ques1
 	printf("Enter first number for question 1: ");
 	scanf ("%d",&a);
	printf("\n");
 	printf("Enter second number for question 1: ");
 	scanf ("%d", &b);
	printf("\n");
	...
	//ques2
  	printf("Enter first number for question 2: ");
 	scanf ("%d",&a);
	printf("\n");
 	printf("Enter second number for question 2: ");
 	scanf ("%d", &b);
	printf("\n");
	...
	t1=ques2(a); //call function ques0; return value is stored in t1 . Next, print out the return value. 
	printf("output of ques2 is t1 = %d  \n", t1);
	t1=ans2(a); //call function ans0, return value is in t1. Next, print out the return value
	printf("output of ans2 is t1 = %d  \n", t1);

	//ques3
  	printf("Enter number for question 3: ");
 	scanf ("%d",&a);
	printf("\n");
	...
	t1=ans3(a); 
	printf("output of ans3 is t1 = %d  \n", t1);

	//ques4
 	printf("Enter first number for question 4: ");
 	scanf ("%d",&a);
	printf("\n");
 	printf("Enter second number for question 4: ");
 	scanf ("%d", &b);
	printf("\n");
	...
	//ques5
  	printf("Enter first number (Not negative) for question 5: ");
 	scanf ("%d",&a);
	printf("\n");
 	printf("Enter second number (Not negative) for question 5: ");
 	scanf ("%d", &b);
	printf("\n");
	...
	printf("output of ans5 is t1 = %d  \n", t1);
  	...
  	printf("Enter first number for question 6: ");
 	scanf ("%d",&a);
	printf("\n");
 	printf("Enter second number for question 6: ");
 	scanf ("%d", &b);
	printf("\n");
	...
	printf("output of ans6 is t1 = %d  \n", t1);
  	...
  	printf("Enter first number for question 7: ");
 	scanf ("%d",&a);
	printf("\n");
 	printf("Enter second number for question 7: ");
 	scanf ("%d", &b);
	printf("\n");
	...
	//ques7
	t1=ques7(a,b); //call function ques0; return value is stored in t1 . Next, print out the return value. 
	printf("output of ques7 is t1 = %d  \n", t1);
	t1=ans7(a,b); //call function ans0, return value is in t1. Next, print out the return value
	printf("output of ans7 is t1 = %d  \n\n", t1);
	
	//quest8
	printf("Ques8:\n");
	t1=ques8; 
	printf("output of ques8 is t1 = %d  \n", t1);
	t1=ans8;
	printf("output of ans8 is t1 = %d  \n", t1);
